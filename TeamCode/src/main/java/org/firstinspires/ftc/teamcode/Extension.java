...
public class Extension {
    ...
    public Extension(DcMotor motor1, double upKp, int upTolerance, double downKp, int downTolerance) {
        this.motor1 = motor1;
        ...
        new Thread() {
            ...
            public void run() {
                while(running) {
                    ...
                    if(encPos1 < liftSetpoint1 - Extension.this.upTolerance) {
                        set1((liftSetpoint1 - encPos1) * Extension.this.upKp);
                    } else if(encPos1 > liftSetpoint1 + Extension.this.downTolerance) {
                        set1((liftSetpoint1 - encPos1) * Extension.this.downKp);
                    } else {
                        set1(0);
                    }
